...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public Employee addEmployee(Employee employee) throws DaoException {
		...
		try {
			...
			LOGGER.error("Exception occured while saving employee", e);
	...
	public Employee updateEmployee(Employee employee) throws DaoException {
		...
		try {
			...
			LOGGER.error("Exception occured while updating employee", e);
			throw new DaoException(e.getMessage());
		} finally {
			session.clear();
		}
	...
	public List<Employee> viewAllEmployee() {
		...
		Query query = session.createQuery("from Employee where enabled=true order by employeeid asc");
		return query.list();
	}
