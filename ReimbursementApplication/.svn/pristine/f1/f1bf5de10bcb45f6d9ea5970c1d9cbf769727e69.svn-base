                  ...
                  <legend>ADD REIMBURSEMENT</legend>
                    ...
                    <div class="form-group">
                       <div class="col-lg-6 col-lg-offset-1">
                           <span class="btn btn-primary" ng-disabled="mainForm.$invalid" onclick="openNav(this)" >Add Item</span>
                       </div>
                    </div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
							<div class="panel-title">
								...
								<a class="pull-right" onclick="closeNav()" id="closeBtn" style="cursor: pointer;"><i class="fa fa-window-close" aria-hidden="true"></i></a>
							</div>
				</div>
				<div class="panel-body">
					 <form id="itemForm" name="itemForm">
						<div class="form-group col-md-12">	 
							...
							<input type="text" name="billNumber" maxlength="20" class="form-control" ng-maxlength="20" title="Bill Number Cannot be Empty" id="billNumber" data-ng-model="ItemModel.billNumber" ng-required="true" />
						...
						<div class="form-group col-md-12">	 
							...
							<input type="date" id="billDate" max="{{maxDate | date:'yyyy-MM-dd'}}" class="form-control"  data-ng-model="ItemModel.billDate" >
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
							    <input type="text" maxlength="10" class="form-control" title="Amount cannot have Letters" pattern="([1-9]+[0-9]*)(\.([0-9]{1,2}))?" id="billAmount" data-ng-model="ItemModel.amount" ng-required="true" />
							</div> 
